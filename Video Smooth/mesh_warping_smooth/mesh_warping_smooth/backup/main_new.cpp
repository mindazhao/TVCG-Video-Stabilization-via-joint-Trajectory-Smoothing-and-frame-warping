...
{
	VideoCapture vc(video_file + video_name + ".avi");
	...
	//read path
	Mat all_path = read_path_and_save_in_mat(path_file + video_name + ".avi_path.txt", org_paths, frame_num);
	...
	Bundled::union_smooth smooth(video_file + video_name + ".avi",
...
int main()
{
	for (int i = 0; i < 1; i++)
	{
		...
		string video_file = "E:/data/TVCG/videos/";
		string path_file = "E:/data/TVCG/paths/";
		string save_path = "E:/data/TVCG/results/";
		double alpha_1 = 20;
		double alpha_2 = 10;
		double Beta_1 = 10;
		double Beta_2 = 80;
